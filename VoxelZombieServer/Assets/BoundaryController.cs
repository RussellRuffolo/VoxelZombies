...
public class BoundaryController : MonoBehaviour
{
    ...
    public void SetMapBoundaries(int length, int width, int height)
    {
        ...
        Vector3 ceilingPosition = new Vector3(l / 2, h + .5f, w / 2);
